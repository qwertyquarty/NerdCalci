...
## [4.8.1] - 2026-06-09
### Fixed
- Fixed app crashing on startup due to an unsupported database index validation mismatch.

## [4.8.0] - 2026-06-09
### Added
- Added global file feature allowing users to define shared variables and functions once and access them across any file using `global.varName` or `global.fnName()` syntax (Issue #76).
...
## [4.5.0] - 2026-05-08
### Added
- Added support for electricity and magnetism unit conversions (PR: #183).

## [4.4.0] - 2026-05-07
### Added
- Added support for optional function arguments (Issue #82).

## [4.3.0] - 2026-05-06
### Added
- Added `N% of what is P` support to find the whole when the part and its percentage are known (Issue #91).

## [4.2.0] - 2026-05-05
### Added
- Added date component extraction functions: `getDay`, `getMonth`, `getYear`, and `daysInMonth` (Issue #179).

### Fixed
- Fixed support for `in <unit>` for interval expressions (Issue #174).
...
- Added a setting to change editor font size (Issue #125).
- Added option to choose from various color palettes to match your mood.
- Added `lustra` as a valid plural for `lustrum` time unit (Issue #124).
